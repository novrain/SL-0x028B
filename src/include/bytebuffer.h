...
#include "class.h"
    ...
    void ByteBuffer_ctor_wrapped(ByteBuffer *me, uint8_t *buff, uint32_t len);
    void ByteBuffer_ctor_copy(ByteBuffer *me, uint8_t *buff, uint32_t len);
     ...
     */
    void ByteBuffer_Compact(ByteBuffer *me);
